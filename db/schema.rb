...
ActiveRecord::Schema.define(version: 2020_07_29_040313) do
  ...
  create_table "topics_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "topic_id"
